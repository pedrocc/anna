...
function SidebarMenuSkeleton({
	...
	// Random width between 50 to 90% for visual variety in skeleton placeholders.
	// NOSONAR: Math.random() is safe here - used only for UI aesthetics, not security purposes.
